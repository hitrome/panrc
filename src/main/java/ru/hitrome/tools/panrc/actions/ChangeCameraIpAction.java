 ...
 */
public class ChangeCameraIpAction extends AbstractAction {
    
    private final ApplicationContext applicationContext;
    
    public ChangeCameraIpAction(ApplicationContext applicationContext) {
        super(LanguageUtil.get(ActionConstants.CHANGE_CAMERA_IP_ACTION));
