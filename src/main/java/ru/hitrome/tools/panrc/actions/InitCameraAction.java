 ...
 */
public class InitCameraAction extends AbstractAction {
    
    private final ApplicationContext applicationContext;
    
    public InitCameraAction(ApplicationContext applicationContext) {
        super(LanguageUtil.get(ActionConstants.INIT_CAMERA_ACTION));
