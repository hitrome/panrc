 ...
 */
public abstract class AbstractActionWithCallback extends AbstractAction {
    
    protected Consumer<Boolean> onExecuted;
    protected boolean actionResult;
    protected boolean delayedResult = false;
    
    public abstract void action(ActionEvent e);
    
    public AbstractActionWithCallback(String name) {
        super(name);
    }

    public void setOnExecuted(Consumer<Boolean> onExecuted) {
