 ...
 */
public class StartRecordAction extends AbstractActionWithCallback {
    
    private final ApplicationContext applicationContext;
    
    public StartRecordAction(ApplicationContext applicationContext) {
        super(LanguageUtil.get(ActionConstants.START_RECORD_ACTION));
