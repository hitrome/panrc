...
import ru.hitrome.tools.panrc.forms.ManualCameraIpForm;

/**
 *
 * @author Roman Novikov <rrl-software@mail.ru>
 */
public class ChangingCamIpManuallyMode implements AbstractApplicationMode {
    
    private ManualCameraIpForm form;
    private boolean result;

    @Override
    public void initMode(ApplicationContext applicationContext) {
        result = false;
        form = new ManualCameraIpForm(applicationContext);
        result = true;
    }
